...
NOTE: Use subagents liberally to maintain minimal context pollution.  Make the
agents do the dirty work (maybe in parallel) and you can focus on the big picture.
