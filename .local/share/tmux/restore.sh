...
$TMUX_BIN split-window -t '13' -h -c '/Users/josh/code/dashboard/SPD-11486-enable-full-linting'
$TMUX_BIN send-keys -t '13' 'opencode' Enter
$TMUX_BIN select-layout -t '13' '97ba,319x77,0,0{79x77,0,0,12,79x77,80,0,36,159x77,160,0,13}' 2>/dev/null || true
...
# --- 24 ---
$TMUX_BIN new-session -d -s '24' -c '/Users/josh/.claude/skills' -x 200 -y 50
$TMUX_BIN send-keys -t '24' 'nvim' Enter
$TMUX_BIN split-window -t '24' -h -c '/Users/josh/.claude/skills'
$TMUX_BIN send-keys -t '24' 'opencode' Enter
$TMUX_BIN select-layout -t '24' '734d,319x77,0,0{159x77,0,0,32,159x77,160,0,35}' 2>/dev/null || true

# --- 25 ---
$TMUX_BIN new-session -d -s '25' -c '/Users/josh' -x 200 -y 50
$TMUX_BIN send-keys -t '25' 'opencode' Enter
$TMUX_BIN select-layout -t '25' '68f7,319x77,0,0,37' 2>/dev/null || true

# --- 26 ---
$TMUX_BIN new-session -d -s '26' -c '/Users/josh' -x 200 -y 50
$TMUX_BIN select-layout -t '26' '68f8,319x77,0,0,38' 2>/dev/null || true
...
tell application "Ghostty"
    ...
    set t to new tab in win with configuration cfg
    set cfg to new surface configuration
    set command of cfg to "/opt/homebrew/bin/tmux -f /Users/josh/.config/tmux/tmux.conf attach-session -t 25"
    set t to new tab in win with configuration cfg
    set cfg to new surface configuration
