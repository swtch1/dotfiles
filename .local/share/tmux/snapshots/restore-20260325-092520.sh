...
$TMUX_BIN send-keys -t '12' 'opencode' Enter
...
# $TMUX_BIN send-keys -t '17' 'rm' Enter
$TMUX_BIN select-layout -t '17' 'e8f0,319x77,$TMUX_BIN new-session -d -s '2' -c '/User$TMUX_BIN new-session -d -s '2' -c '/Users/josh' -x 200 -y 50
$TMUX_BIN select-layout -t '2' 'd980,319x79$TMUX_BIN new-session -d -s '3' -c '/User$TMUX_BIN new-session -d -s '3' -c '/Users/josh' -x 200 -y 50
$TMUX_BIN select-layout -t '3' 'd981,319x79$TMUX_BIN new-session -d -s '4' -c '/User$TMUX_BIN new-session -d -s '4' -c '/Users/josh/code/ss/pristine' -x 200 -y 50
$TMUX_BIN select-layout -t '4' 'd982,319x79$TMUX_BIN new-session -d -s '5' -c '/User$TMUX_BIN new-session -d -s '5' -c '/Users/josh' -x 200 -y 50
...
tell application "Ghostty"
    ...
    set t to new tab in win with configuration cfg
    set cfg to new surface configuration
    set command of cfg to "/opt/homebrew/bin/tmux -f /Users/josh/.config/tmux/tmux.conf attach-session -t 17"
    set t to new tab in win with configuration cfg
end tell
APPLESCRIPT
