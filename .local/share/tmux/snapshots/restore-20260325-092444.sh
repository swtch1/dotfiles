...
# --- 16 ---
$TMUX_BIN new-session -d -s '16' -c '/Users/josh' -x 200 -y 50
$TMUX_BIN select-layout -t '16' 'e8ef,319x77,0,0,20' 2>/dev/null || true
...
tell application "Ghostty"
    ...
    set t to new tab in win with configuration cfg
    set cfg to new surface configuration
    set command of cfg to "/opt/homebrew/bin/tmux -f /Users/josh/.config/tmux/tmux.conf attach-session -t 16"
    set t to new tab in win with configuration cfg
end tell
APPLESCRIPT
