...
$TMUX_BIN select-layout -t '12' '68f0,319x77,0,0,11' 2>/dev/null || true

# --- 13 ---
$TMUX_BIN new-session -d -s '13' -c '/Users/josh' -x 200 -y 50
# $TMUX_BIN send-keys -t '13' 'grep' Enter
$TMUX_BIN select-layout -t '13' '68f1,319x77,0,0,12' 2>/dev/null || true
