...
$TMUX_BIN select-layout -t '18' 'e8f1,319x77,0,0,22' 2>/dev/null || true

# --- 19 ---
$TMUX_BIN new-session -d -s '19' -c '/Users/josh' -x 200 -y 50
# $TMUX_BIN send-keys -t '19' 'grep' Enter
$TMUX_BIN select-layout -t '19' 'e8f2,319x77,0,0,23' 2>/dev/null || true
