...
# --- 10 ---
$TMUX_BIN new-session -d -s '10' -c '/Users/josh' -x 200 -y 50
$TMUX_BIN select-layout -t '10' 'd986,319x79,0,0,9' 2>/dev/null || true
...
# --- 8 ---
$TMUX_BIN new-session -d -s '8' -c '/Users/josh/code/dashboard/master' -x 200 -y 50
$TMUX_BIN select-layout -t '8' 'd184,319x77,0,0,7' 2>/dev/null || true

osascript - <<'APPLESCRIPT'
tell application "Ghostty"
    activate
    set cfg to new surface configuration
    set command of cfg to "/opt/homebrew/bin/tmux -f /Users/josh/.config/tmux/tmux.conf attach-session -t 10"
    set win to new window with configuration cfg
    set cfg to new surface configuration
    set command of cfg to "/opt/homebrew/bin/tmux -f /Users/josh/.config/tmux/tmux.conf attach-session -t 8"
